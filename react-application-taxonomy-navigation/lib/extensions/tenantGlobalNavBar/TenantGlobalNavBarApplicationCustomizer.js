...
var TenantMegaMenu_1 = require("./components/TenantMegaMenu");
var SPTermStore = require("./services/SPTermStoreService");
...
var TenantGlobalNavBarApplicationCustomizer = (function (_super) {
    ...
    TenantGlobalNavBarApplicationCustomizer.prototype.onInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var termStoreService, cachedTerms, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(this.properties.TopMenuTermSet != null)) return [3 /*break*/, 3];
                        cachedTerms = sp_pnp_js_1.default.storage.session.get(NAV_TERMS_KEY);
                    ...
                    case 2:
                        ...
                        sp_pnp_js_1.default.storage.session.put(NAV_TERMS_KEY, this._topMenuItems);
                        _c.label = 3;
                    case 3:
                        if (!(this.properties.BottomMenuTermSet != null)) return [3 /*break*/, 5];
                        _b = this;
        ...
        if (!this._topPlaceholder) {
            ...
            if (this._topMenuItems != null && this._topMenuItems.length > 0) {
                ...
                switch (this.properties.TopNavStyle) {
                    case 'megaMenu': {
                        var megaMenu = React.createElement(TenantMegaMenu_1.default, {
                    ...
                    default: {
                        var commandBarMenu = React.createElement(TenantGlobalNavBar_1.default, {
                            menuItems: this._topMenuItems,
                        });
