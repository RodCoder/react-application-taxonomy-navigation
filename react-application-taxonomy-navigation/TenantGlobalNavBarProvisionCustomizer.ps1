...
Connect-PnPOnline "https://spinexltd.sharepoint.com/sites/EventsandConferences" -Credentials $credentials
...
$ca.ClientSideComponentProperties = "{""TopMenuTermSet"":""TenantGlobalNavBar"",""BottomMenuTermSet"":""TenantGlobalFooterBar"",""TopNavStyle"":""megaMenu""}"
